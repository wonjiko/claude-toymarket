---
name: Commit
description: This skill should be used when the user wants to "commit", "make a commit", "save changes", or needs to create a git commit following Conventional Commit format. Automatically analyzes staged/unstaged changes and generates a one-line conventional commit message.
version: 0.1.0
---
